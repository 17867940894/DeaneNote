...
>       4. 动态地将元素装入容器
>
>    ![](./assets/屏幕截图 2023-11-18 161720.png)
>
...
>
> ![](./assets/屏幕截图 2023-11-23 223337.png)
...
>
>浏览器环境下：  
> ![在这里插入图片描述](./assets/204a9af926644411af24e0b410a9cd2e.png)  
> node 环境下：
>
>``` javascript
> console.log(this) // {}
...
>
> 浏览器环境下：  
>![在这里插入图片描述](./assets/9eb10d99400b410391302ef7acc5ed72.png)  
> node 环境下：
>
> ``` javascript
>function foo(){
...
>
> 输出结果：  
>![在这里插入图片描述](./assets/c86d90f1c01f4b12bbf20211437a16a9.png)
>
> **4、事件中的 this**
>
...
>
>
> ![在这里插入图片描述](./assets/cb3ccb5678394075b2d2f05bfb343973.png)  
...
>
>
> ![在这里插入图片描述](./assets/147095e5a93c40108893d9ef30f8f143.png)
>
...
>
> ![在这里插入图片描述](./assets/20200808173852577.png)
>
> 数组的 push()方法能被重写
>
> ``` js
...
>
> ![在这里插入图片描述](./assets/20200808175814193.png)
...
>
>    ![在这里插入图片描述](./assets/20200808180624796.png)
>
...
>
> ![在这里插入图片描述](./assets/20200808180257297.png)
>
...
>
>    ![在这里插入图片描述](./assets/20200808182400179.png)
>
...
> 剪切并添加数据：
>
> ![在这里插入图片描述](./assets/20200808184332156.png)
>
>
>
>
>
> ![在这里插入图片描述](./assets/2020080818581785.png)
>
> 只添加数据：
>
> ![在这里插入图片描述](./assets/20200808184621944.png)
>
> 注意：
> 数组的方法允许使用负数的下标
>
...
> ```
>
> ![在这里插入图片描述](./assets/20200809145437235.png)
...
>
> ![在这里插入图片描述](./assets/20200809145952737.png)
...
> ```
>
> ![在这里插入图片描述](./assets/2020080915145225.png)
>
...
>
> ![在这里插入图片描述](./assets/20200809155406988.png)
>
...
>
> ![在这里插入图片描述](./assets/20200809155608860.png)
...
> ```
>
> ![在这里插入图片描述](./assets/bd4f4855da6744eeb2401cd1a47f69e9.png)
>
> 无初始值
>
> ``` js
...
> ```
>
> ![在这里插入图片描述](./assets/dab9d574146841e18b667b7b013f92c2.png)
>
...
> ```
>
> ![在这里插入图片描述](./assets/20210409113232277.png)
>
> 返回值：
