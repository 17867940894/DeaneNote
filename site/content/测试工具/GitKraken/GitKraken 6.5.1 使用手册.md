...
> 🦑 最强 [[../../测试笔记/DB/Git/git.md|Git]] 图形化客户端 · 可视化分支管理 · 高效协作开发
>
...
GitKraken 是一款跨平台的 [[../../测试笔记/DB/Git/git.md|Git]] 图形化客户端，由 Axosoft 开发。它以直观的可视化分支图、流畅的交互体验和强大的协作功能著称，是目前最受欢迎的 [[../../测试笔记/DB/Git/git.md|Git]] GUI 工具之一。
...
> **ℹ️ 前置条件**
>
> GitKraken 底层调用系统 [[../../测试笔记/DB/Git/git.md|Git]] 可执行文件，建议提前安装 Git CLI（2.11+）并配置好 `user.name` 和 `user.email`。
