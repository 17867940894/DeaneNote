...
![image-29](测试工具/assets/image-29.png)
...
![image-31](测试工具/assets/image-31.png)

![image-33](测试工具/assets/image-33.png)

现在可以查看元素的 placeholder 样式了：

![image-34](测试工具/assets/image-34.png)

## 测试页面性能和 SEO

![image-35](测试工具/assets/image-35.png)

下面是测试报告：

![image-36](测试工具/assets/image-36.png)
...
![image-37](测试工具/assets/image-37.png)
...
![image-38](测试工具/assets/image-38.png)
...
![image-39](测试工具/assets/image-39.png)

点击左上角的 `Record` 按钮开始记录，然后你模拟正常用户使用网页。测试完毕后，点击 `Stop`。

![image-40](测试工具/assets/image-40.png)
...
![image-41](测试工具/assets/image-41.png)
...
![image-43](测试工具/assets/image-43.png)

点击左边竖形排列的三个小点，选择 `Rendering`：

![image-42](测试工具/assets/image-42.png)
