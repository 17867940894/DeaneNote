...
JavaScript 语言具有很强的[[5-面向对象]]编程能力，本章介绍 JavaScript 面向对象编程的基础知识。
...
一本书、一辆汽车、一个人都可以是对象，一个[[16-数据库]]、一张网页、一个远程服务器连接也可以是对象。当实物被抽象成对象，实物之间的关系就变成了对象之间的关系，从而就可以模拟现实情况，针对对象进行编程。
