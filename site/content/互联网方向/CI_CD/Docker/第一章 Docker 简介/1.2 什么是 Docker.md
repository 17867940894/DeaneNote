...
**Docker 是一种轻量级的虚拟化技术，它让应用程序及其依赖环境可以被打包成一个标准化的单元，在满足架构、内核能力和外部依赖前提的环境中高度一致地运行。**
...
Docker 解决的是软件开发中最古老的问题之一：**“在我机器上明明能跑啊！”**
...
![传统虚拟化](互联网方向/CI_CD/Docker/assets/img-949fce0701bcefdb.png)

### 3.2 Docker 容器

Docker 容器内的应用直接运行于宿主的内核，容器内没有自己的内核，也没有进行硬件虚拟。

![Docker](互联网方向/CI_CD/Docker/assets/img-7cf15837771c7de3.png)
...
![Docker 架构](互联网方向/CI_CD/Docker/assets/img-2fec43bd58c0575b.png)
...
Docker 的成功推动了整个容器生态的发展，催生了 Kubernetes、Podman 等众多相关项目。Docker 最大的贡献不仅是技术本身，更是它 **让容器技术从系统管理员的工具变成了每个开发者都能使用的标准工具**。
