...
![Drop Playwright Trace to load](互联网方向/Ai 测试/Python Playwright/Basics/assets/194577918-b4d45726-2692-4093-8a28-9e73552617ef.png)
...
![actions tab in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/948b65cd-f0fd-4c7f-8e53-2c632b5a07f1.png)
...
![timeline view in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/b04a7d75-54bb-4ab2-9e30-e76f6f74a2c8.png)
...
![action tab in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/7168d549-eb0a-4964-9c93-483f03711fa9.png)
...
![showing source code tab in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/daa8845d-c250-4923-aa7a-5d040da9adc5.png)

### 调用 (Call)

“调用”选项卡显示有关操作的信息，例如它花费的时间、使用的定位符、是否处于严格模式以及使用的键。

![showing call tab in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/95498580-f9dd-4932-a123-c37fe7cfc3c2.png)

### 日志 (Log)

查看测试的完整日志，以更好地了解 Playwright 在幕后正在做什么，例如滚动到视图中、等待元素可见、启用和稳定，以及执行点击、填充、按下等操作。

![showing log of tests in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/de621461-3bab-4140-b39d-9f02d6672dbf.png)

### 错误 (Errors)

如果您的测试失败，您将在“错误”选项卡中看到每个测试的错误消息。时间线还将显示一条红线，突出显示错误发生的位置。您还可以单击“源”选项卡以查看错误在源代码的哪一行。

![showing errors in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/e9ef77b3-05d1-4df2-852c-981023723d34.png)

### 控制台 (Console)

查看来自浏览器以及测试的控制台日志。显示不同的图标以显示控制台日志是来自浏览器还是来自测试文件。

![showing log of tests in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/4107c08d-1eaf-421c-bdd4-9dd2aa641d4a.png)
...
![network requests tab in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/0a3d1671-8ccd-4f7a-a844-35f5eb37f236.png)
...
![meta data in trace viewer](互联网方向/Ai 测试/Python Playwright/Basics/assets/82ab3d33-1ec9-4b8a-9cf2-30a6e2d59091.png)
