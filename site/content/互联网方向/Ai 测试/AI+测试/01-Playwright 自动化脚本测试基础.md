...
| --------- | ---------------------- | ---------------------------------------------------------------- | ---------- |
| Web 自动化   | Playwright（微软）         | ✅ 跨浏览器（Chrome/Firefox/Edge）、API 简洁、内置等待、支持录制<br>❌ 生态比 Selenium 稍新 | 企业级 Web 应用 |
...
![第 7 页图片](互联网方向/Ai 测试/AI+测试/assets/p0007_01.png)
...
![第 18 页图片](互联网方向/Ai 测试/AI+测试/assets/p0018_02.png)
...
![第 26 页图片](互联网方向/Ai 测试/AI+测试/assets/p0026_03.png)
...
![第 28 页图片](互联网方向/Ai 测试/AI+测试/assets/p0028_04.png)
...
![第 30 页图片](互联网方向/Ai 测试/AI+测试/assets/p0030_05.png)
...
![第 34 页图片](互联网方向/Ai 测试/AI+测试/assets/p0034_06.png)
...
![第 37 页图片](互联网方向/Ai 测试/AI+测试/assets/p0037_07.png)
...
![第 38 页图片](互联网方向/Ai 测试/AI+测试/assets/p0038_08.png)
...
![第 40 页图片](互联网方向/Ai 测试/AI+测试/assets/p0040_09.png)
...
def run(playwright: Playwright) -> None:
    ...
    page.locator("#setName ").fill(" 鲜果优选旗舰店 22 ")
    # ... 更多操作
```
