...
![第 5 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_03.png)
...
![第 5 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_02.png)
...
![第 6 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_04.png)
...
![第 8 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_06.png)

![第 8 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_07.png)

![第 8 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_05.png)

![第 9 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_08.png)
...
![第 10 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_09.png)

![第 10 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_10.png)
...
![第 11 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_06.png)

![第 12 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_11.png)

![第 13 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_12.png)
...
![第 14 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_14.png)

![第 14 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_15.png)

找到 uv.exe 和 uvx.exe 所在目录（如 `C:\Users\【用户名】\AppData\Roaming\Python\Python313\Scripts\`），添加到系统环境变量 Path 中：

![第 14 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_13.png)

![第 15 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_16.png)

![第 15 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_17.png)

![第 16 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_18.png)

![第 16 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_19.png)

![第 17 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_20.png)

新开一个 PowerShell，输入 `uv --version`，确认可以找到 uv。

![第 17 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_21.png)

重启 Trae，等待 MySQL MCP 服务安装并重启：

![第 18 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_22.png)

**验证 MySQL MCP 功能**：

![第 19 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_24.png)

![第 19 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_23.png)
...
![第 20 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_25.png)

![第 20 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_26.png)

![第 21 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_27.png)
...
![第 22 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_28.png)

配置 Token：

![第 23 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_30.png)
...
![第 23 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_29.png)

![第 24 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_31.png)

**验证功能**：让 Trae 去 Gitee 克隆代码仓库（注意：必须触发 gitee 关键词，否则智能体不会调用该能力）

![第 25 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_33.png)

修改文件并让 Trae 提交：

![第 25 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_32.png)

![第 26 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_34.png)

推送到远程仓库：

![第 26 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_35.png)

![第 27 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_36.png)

![第 27 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_37.png)

![第 27 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_38.png)
...
![第 28 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_39.png)
...
![第 29 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_40.png)
...
![第 30 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_41.png)
...
![第 31 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_42.png)
...
![第 32 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_43.png)
...
![第 33 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_45.png)

![第 33 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_44.png)

![第 34 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_46.png)

#### （5）51ticket 网址测试

**准备工作**：新建 Gitee 代码仓库，本地 clone：`git@gitee.com:fu-laoshi2025/project_51tickets_stf108.git`

![第 35 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_47.png)
...
![第 36 页图片](互联网方向/Ai 测试/AI+测试/assets/p0001_48.png)
