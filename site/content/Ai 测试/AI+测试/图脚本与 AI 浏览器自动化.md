...
![第3页图片](Ai 测试/AI+测试/assets/p0001_08-1786434900885-57.png)
...
![第4页图片](Ai 测试/AI+测试/assets/p0001_20-1786434900886-58.png)

![第4页图片](Ai 测试/AI+测试/assets/p0001_31-1786434900886-59.png)

![第4页图片](Ai 测试/AI+测试/assets/p0001_42-1786434900886-60.png)

![第5页图片](Ai 测试/AI+测试/assets/p0001_02-1786434900886-61.png)
...
![第5页图片](Ai 测试/AI+测试/assets/p0001_04-1786434900886-62.png)

![第7页图片](Ai 测试/AI+测试/assets/p0001_06-1786434900886-63.png)

![第7页图片](Ai 测试/AI+测试/assets/p0001_07-1786434900886-64.png)

**示例 2：用 DeepSeek 大模型，登录 Gitee 并统计仓库数量**

必要前置条件：准备好大模型的 API Key。

![第7页图片](Ai 测试/AI+测试/assets/p0001_05-1786434900886-65.png)
...
![第9页图片](Ai 测试/AI+测试/assets/p0001_09-1786434900886-66.png)

![第9页图片](Ai 测试/AI+测试/assets/p0001_10-1786434900886-67.png)

**示例 3：用 Ollama 指定大模型，登录 Gitee 并统计仓库**

必要前置条件：安装并启动 Ollama。

![第10页图片](Ai 测试/AI+测试/assets/p0001_11-1786434900886-68.png)

> 注意：选择的大模型要与代码中的模型名称相对应。

![第10页图片](Ai 测试/AI+测试/assets/p0001_12-1786434900886-69.png)
...
![第12页图片](Ai 测试/AI+测试/assets/p0001_13-1786434900886-70.png)

![第12页图片](Ai 测试/AI+测试/assets/p0001_14-1786434900886-71.png)

![第13页图片](Ai 测试/AI+测试/assets/p0001_16-1786434900886-72.png)

#### （5）代码结构改造——任务与代码解耦

**改造思路**：将任务描述独立存储在纯文本文件中，修改任务无需改动代码，降低维护成本。

![第13页图片](Ai 测试/AI+测试/assets/p0001_15-1786434900886-73.png)
...
![第15页图片](Ai 测试/AI+测试/assets/p0001_17-1786434900886-74.png)
...
![第17页图片](Ai 测试/AI+测试/assets/p0001_18-1786434900886-75.png)

![第18页图片](Ai 测试/AI+测试/assets/p0001_19-1786434900886-76.png)

![第18页图片](Ai 测试/AI+测试/assets/p0001_21-1786434900886-77.png)
...
![第19页图片](Ai 测试/AI+测试/assets/p0001_22-1786434900886-78.png)

![第20页图片](Ai 测试/AI+测试/assets/p0001_23-1786434900886-79.png)
...
![第25页图片](Ai 测试/AI+测试/assets/p0001_24-1786434900886-80.png)

#### （2）简单功能演示

**信息收集类任务**：

![第26页图片](Ai 测试/AI+测试/assets/p0001_26-1786434900886-81.png)
...
![第26页图片](Ai 测试/AI+测试/assets/p0001_25-1786434900886-82.png)

![第27页图片](Ai 测试/AI+测试/assets/p0001_27-1786434900886-83.png)

观察效果：Fellou 自动打开网址、等待加载。

![第27页图片](Ai 测试/AI+测试/assets/p0001_28-1786434900886-84.png)
...
![第28页图片](Ai 测试/AI+测试/assets/p0001_30-1786434900886-85.png)

```text
访问百度，搜索"美食"，点击一条搜索记录。
```

![第28页图片](Ai 测试/AI+测试/assets/p0001_32-1786434900886-86.png)

![第28页图片](Ai 测试/AI+测试/assets/p0001_29-1786434900886-87.png)

![第29页图片](Ai 测试/AI+测试/assets/p0001_33-1786434900886-88.png)
...
![第29页图片](Ai 测试/AI+测试/assets/p0001_34-1786434900886-89.png)

![第30页图片](Ai 测试/AI+测试/assets/p0001_35-1786434900886-90.png)

![第30页图片](Ai 测试/AI+测试/assets/p0001_36-1786434900886-91.png)
...
![第31页图片](Ai 测试/AI+测试/assets/p0001_37-1786434900886-92.png)

![第32页图片](Ai 测试/AI+测试/assets/p0001_38-1786434900886-93.png)

![第32页图片](Ai 测试/AI+测试/assets/p0001_39-1786434900886-94.png)
...
![第33页图片](Ai 测试/AI+测试/assets/p0001_40-1786434900886-95.png)
...
![第35页图片](Ai 测试/AI+测试/assets/p0001_43-1786434900886-96.png)
...
![第35页图片](Ai 测试/AI+测试/assets/p0001_41-1786434900886-97.png)
...
![第36页图片](Ai 测试/AI+测试/assets/p0001_44-1786434900886-98.png)

![第36页图片](Ai 测试/AI+测试/assets/p0001_45-1786434900886-99.png)
...
![第37页图片](Ai 测试/AI+测试/assets/p0001_46-1786434900886-100.png)

![第37页图片](Ai 测试/AI+测试/assets/p0001_47-1786434900886-101.png)

```text
写脚本，批量提取页面所有按钮的 ID 和文本，导出为 JSON。
```

![第38页图片](Ai 测试/AI+测试/assets/p0001_49.png)
...
![第38页图片](Ai 测试/AI+测试/assets/p0001_48-1786434900886-102.png)

![第39页图片](Ai 测试/AI+测试/assets/p0001_50.png)
...
![第40页图片](Ai 测试/AI+测试/assets/p0001_51.png)
...
![第41页图片](Ai 测试/AI+测试/assets/p0001_52.png)
...
![第42页图片](Ai 测试/AI+测试/assets/p0001_03-1786434900886-103.png)
