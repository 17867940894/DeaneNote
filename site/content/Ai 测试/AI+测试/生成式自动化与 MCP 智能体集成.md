...
![第5页图片](Ai 测试/AI+测试/assets/p0001_03.png)
...
![第5页图片](Ai 测试/AI+测试/assets/p0001_02.png)
...
![第6页图片](Ai 测试/AI+测试/assets/p0001_04.png)
...
![第8页图片](Ai 测试/AI+测试/assets/p0001_06.png)

![第8页图片](Ai 测试/AI+测试/assets/p0001_07.png)

![第8页图片](Ai 测试/AI+测试/assets/p0001_05.png)

![第9页图片](Ai 测试/AI+测试/assets/p0001_08.png)
...
![第10页图片](Ai 测试/AI+测试/assets/p0001_09.png)

![第10页图片](Ai 测试/AI+测试/assets/p0001_10.png)
...
![第11页图片](Ai 测试/AI+测试/assets/p0001_06.png)

![第12页图片](Ai 测试/AI+测试/assets/p0001_11.png)

![第13页图片](Ai 测试/AI+测试/assets/p0001_12.png)
...
![第14页图片](Ai 测试/AI+测试/assets/p0001_14.png)

![第14页图片](Ai 测试/AI+测试/assets/p0001_15.png)

找到 uv.exe 和 uvx.exe 所在目录（如 `C:\Users\【用户名】\AppData\Roaming\Python\Python313\Scripts\`），添加到系统环境变量 Path 中：

![第14页图片](Ai 测试/AI+测试/assets/p0001_13.png)

![第15页图片](Ai 测试/AI+测试/assets/p0001_16.png)

![第15页图片](Ai 测试/AI+测试/assets/p0001_17.png)

![第16页图片](Ai 测试/AI+测试/assets/p0001_18.png)

![第16页图片](Ai 测试/AI+测试/assets/p0001_19.png)

![第17页图片](Ai 测试/AI+测试/assets/p0001_20.png)

新开一个 PowerShell，输入 `uv --version`，确认可以找到 uv。

![第17页图片](Ai 测试/AI+测试/assets/p0001_21.png)

重启 Trae，等待 MySQL MCP 服务安装并重启：

![第18页图片](Ai 测试/AI+测试/assets/p0001_22.png)

**验证 MySQL MCP 功能**：

![第19页图片](Ai 测试/AI+测试/assets/p0001_24.png)

![第19页图片](Ai 测试/AI+测试/assets/p0001_23.png)
...
![第20页图片](Ai 测试/AI+测试/assets/p0001_25.png)

![第20页图片](Ai 测试/AI+测试/assets/p0001_26.png)

![第21页图片](Ai 测试/AI+测试/assets/p0001_27.png)
...
![第22页图片](Ai 测试/AI+测试/assets/p0001_28.png)

配置 Token：

![第23页图片](Ai 测试/AI+测试/assets/p0001_30.png)
...
![第23页图片](Ai 测试/AI+测试/assets/p0001_29.png)

![第24页图片](Ai 测试/AI+测试/assets/p0001_31.png)

**验证功能**：让 Trae 去 Gitee 克隆代码仓库（注意：必须触发 gitee 关键词，否则智能体不会调用该能力）

![第25页图片](Ai 测试/AI+测试/assets/p0001_33.png)

修改文件并让 Trae 提交：

![第25页图片](Ai 测试/AI+测试/assets/p0001_32.png)

![第26页图片](Ai 测试/AI+测试/assets/p0001_34.png)

推送到远程仓库：

![第26页图片](Ai 测试/AI+测试/assets/p0001_35.png)

![第27页图片](Ai 测试/AI+测试/assets/p0001_36.png)

![第27页图片](Ai 测试/AI+测试/assets/p0001_37.png)

![第27页图片](Ai 测试/AI+测试/assets/p0001_38.png)
...
![第28页图片](Ai 测试/AI+测试/assets/p0001_39.png)
...
![第29页图片](Ai 测试/AI+测试/assets/p0001_40.png)
...
![第30页图片](Ai 测试/AI+测试/assets/p0001_41.png)
...
![第31页图片](Ai 测试/AI+测试/assets/p0001_42.png)
...
![第32页图片](Ai 测试/AI+测试/assets/p0001_43.png)
...
![第33页图片](Ai 测试/AI+测试/assets/p0001_45.png)

![第33页图片](Ai 测试/AI+测试/assets/p0001_44.png)

![第34页图片](Ai 测试/AI+测试/assets/p0001_46.png)

#### （5）51ticket 网址测试

**准备工作**：新建 Gitee 代码仓库，本地 clone：`git@gitee.com:fu-laoshi2025/project_51tickets_stf108.git`

![第35页图片](Ai 测试/AI+测试/assets/p0001_47.png)
...
![第36页图片](Ai 测试/AI+测试/assets/p0001_48.png)
