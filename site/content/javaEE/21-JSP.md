...
> ​	网上参考地址为：
>
> ![image-20240426143529565](javaEE/assets/image-20240426143529565.png)
...
>
>    <img src="assets/image-20240426144332762.png" alt="image-20240426144332762" style="zoom:200%;" />
>
> 2. `<% java代码 %>`
>
>    java代码在service()==方法中==
>
>    ![image-20240426144532154](javaEE/assets/image-20240426144532154.png)
>
> 3. `<%! java代码 %>`
>
>    java代码在jsp转换成Servlet类的成员位置
>    
>    ![image-20240426144611397](javaEE/assets/image-20240426144611397.png)

> jsp中的注释：`<%-- 注释内容 --%>`
>
> 注：`<!-- -->`和`<%-- --%>`都可以将页面中标签和java代码进行注释，区别是`<!-- -->`是将显示的内容注释掉从而变得不显示；`<%-- --%>`中的代码都不会被翻译成Servlet中的java代码
>
> ![image-20240426150106216](javaEE/assets/image-20240426150106216.png)
...
>
>    ![image-20240429192155491](javaEE/assets/image-20240429192155491.png)
>
>    错误页面设置如下：
>
>    ```jsp
...
>    第二种方式:
>
>    ![image-20240428193717128](javaEE/assets/image-20240428193717128.png)
...
>
>    <img src="assets/image-20240505225350258.png" alt="image-20240505225350258" style="zoom:150%;" />
>
> 3. 忽略el表达式
>
...
> ![image-20240505145547691](javaEE/assets/image-20240505145547691.png)
...
> 5. param:通过键获取值
>
> 6. paramValues:[[数组]]和集合类型的数据通过键获取值
>
> 格式：
>
> ```js
...
> ```
>
> ![image-20240507192652220](javaEE/assets/image-20240507192652220.png)

##### 5.3.3 获取请求头中的参数

> 7. header
>
>    ![image-20240507193955490](javaEE/assets/image-20240507193955490.png)
>
> 8. headerValues
>
> 格式：
...
> ```
>
> ![image-20240508110607283](javaEE/assets/image-20240508110607283.png)
...
> ```
>
> ![image-20240508111640628](javaEE/assets/image-20240508111640628.png)
...
>    ```
>    
>    ![image-20240508114731575](javaEE/assets/image-20240508114731575.png)
...
>
> ![image-20240508150708240](javaEE/assets/image-20240508150708240.png)
>
> 重启项目，即可成功
...
> 4. `otherwise`标签只能出现在最后
>
> ![image-20240509172910576](javaEE/assets/image-20240509172910576.png)
...
>    			2. count：循环的次数
>
> ![image-20240509194643008](javaEE/assets/image-20240509194643008.png)
...
>         %>
>         <hr>
>         <%--<c:forEach begin="1" end="${10-1}" var="i" step="1">
>     <p>按钮: ${i}</p>
>         </c:forEach>--%>
>         <hr>
...
> ```
>
> <img src="assets/image-20240509211615124.png" alt="image-20240509211615124" style="zoom:200%;" />
