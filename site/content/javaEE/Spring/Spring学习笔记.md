...
![spring overview](javaEE/Spring/assets/Spring-day01-00.png) 

> Spring 框架是一个分层架构，由 7 个定义良好的模块组成。 

![img](javaEE/Spring/assets/Spring-day01-01.png) 

### 1.4 拓展

- 在[Spring的官网](https://spring.io.xy2401.com/)有这个介绍：现代化的Java开发！说白了就是基于Spring的开发！

![1609245847814](javaEE/Spring/assets/Spring-day01-02.png)
...
![1609248439988](javaEE/Spring/assets/Spring-day01-03.png)

![1609251457665](javaEE/Spring/assets/Spring-day01-04.png)
...
5. 测试类MyTest
   ...
   ![1609251866840](javaEE/Spring/assets/Spring-day01-05.png)

   ![1609251830167](javaEE/Spring/assets/Spring-day01-05-2.png)

   ![1609251907595](javaEE/Spring/assets/05-3.png)
...
![1609252002365](javaEE/Spring/assets/Spring-day01-06.png)

![1609252092685](javaEE/Spring/assets/06-2.png)

![1609252044271](javaEE/Spring/assets/Spring-day01-07.png)
...
![1609252703490](javaEE/Spring/assets/Spring-day01-08.png)

### 2.2 IOC的本质

> **控制反转loC(Inversion of Control)，是一种设计思想，DI（依赖注入）是实现loC的一种方法**，也有人认为DI只是loC的另一种说法。没有loC的程序中，我们使用[[5-面向对象]]编程，对象的创建与对象间的依赖关系完全硬编码在程序中，对象的创建由程序自己控制，控制反转后将对象的创建转移给第三方，个人认为所谓控制反转就是：获得依赖对象的方式反转了。

![1609253346004](javaEE/Spring/assets/Spring-day01-09.png)

- **IoC是Spring框架的核心内容**，使用多种方式完美的实现了IoC，可以使用XML配置，也可以使用注解，新版本的Spring也可以零配置实现IoC。

- Spring容器在初始化时先读取配置文件，根据配置文件或元数据创建与组织对象存入容器中，程序使用时再从Ioc容器中取出需要的对象。

 ![container magic](javaEE/Spring/assets/Spring-day01-10.png) 
...
![1609845041082](javaEE/Spring/assets/Spring-day02-01.png)
...
![1609848547723](javaEE/Spring/assets/Spring-day02-02.png)
...
![未命名文件](javaEE/Spring/assets/Spring-day02-03.png)

> 修改案例一：

![1609851677324](javaEE/Spring/assets/Spring-day02-04.png)
...
![1609851900192](javaEE/Spring/assets/Spring-day02-05.png)

![1609851952096](javaEE/Spring/assets/Spring-day02-06.png)
...
![1609852961195](javaEE/Spring/assets/Spring-day02-07.png)
...
![1609853014890](javaEE/Spring/assets/Spring-day02-08.png)
...
![1609854150371](javaEE/Spring/assets/Spring-day02-09.png)

![1609854446445](javaEE/Spring/assets/Spring-day02-10.png)

![1609854536967](javaEE/Spring/assets/Spring-day02-11.png)
...
![1609855861794](javaEE/Spring/assets/Spring-day02-12.png)

![1609855944587](javaEE/Spring/assets/Spring-day02-13.png)

![1609856048981](javaEE/Spring/assets/Spring-day02-14.png)
...
![1609856499565](javaEE/Spring/assets/Spring-day02-15.png)
...
![1609934901444](javaEE/Spring/assets/Spring-day03-01.png)
...
![1609935136433](javaEE/Spring/assets/Spring-day03-02.png)
...
![1609936790143](javaEE/Spring/assets/Spring-day03-03.png)
...
![1609938899022](javaEE/Spring/assets/Spring-day03-05-2.png)
...
![1609937803735](javaEE/Spring/assets/Spring-day03-04.png)

![1609937862590](javaEE/Spring/assets/Spring-day03-05.png)
...
![1609938243398](javaEE/Spring/assets/Spring-day03-06.png)

- 解决：把有参、无参构造器加上。
- 由此可知：c 就是所谓的构造器注入！

![1609938389623](javaEE/Spring/assets/Spring-day03-07.png)
...
![1609938556801](javaEE/Spring/assets/Spring-day03-08.png)
...
![1609939335758](javaEE/Spring/assets/Spring-day03-09.png)
...
![singleton](javaEE/Spring/assets/Spring-day03-10.png) 
...
![1609940229409](javaEE/Spring/assets/Spring-day03-11.png)
...
![prototype](javaEE/Spring/assets/Spring-day03-12.png)  

----

> 在XML中将bean定义成[[prototype]]，可以这样配置：
...
![1609940444947](javaEE/Spring/assets/Spring-day03-13.png)
...
![1609943833107](javaEE/Spring/assets/Spring-day03-14.png)
...
![1609943955320](javaEE/Spring/assets/Spring-day03-15.png)
...
![1609946086951](javaEE/Spring/assets/Spring-day03-16.png)
...
![1609946183748](javaEE/Spring/assets/Spring-day03-17.png)
...
![1611539451320](javaEE/Spring/assets/Spring-day03-18.png)
...
![1611539285989](javaEE/Spring/assets/Spring-day03-19.png)

![1611539578095](javaEE/Spring/assets/Spring-day03-20.png)
...
![1611540617852](javaEE/Spring/assets/19-2.png)

- 如果@Autowired自动装配的环境比较复杂，自动装配无法通过一个注解【@Autowired】完成的时候、我们可以使用@Qualifier(value="xxx")去配置@Autowired的使用，指定一个唯一的bean对象注入！

![1611540385475](javaEE/Spring/assets/Spring-day03-21.png)
...
![1611540718343](javaEE/Spring/assets/Spring-day03-22.png)

#### @Resource

![1611540837210](javaEE/Spring/assets/Spring-day03-23.png)

![1611540872172](javaEE/Spring/assets/24.png)

![1611540950048](javaEE/Spring/assets/25.png)

![1611541217803](javaEE/Spring/assets/26.png)
...
![1611541258020](javaEE/Spring/assets/27.png)
...
>
> 而@Resource如果指定了name，则用byName自动装配，如果指定了type，则用byType自动装配。
>
> (三)、注解应用的地方不同
>
> @Autowired能够用在：`构造器`、方法、参数、成员变量和`注解`上，而@Resource能用在：类、成员变量和方法上。
>
> (四)、出处不同
>
...
![1611542131550](javaEE/Spring/assets/28.png)
...
![1611545022268](javaEE/Spring/assets/00-1.png)
...
![1611544783247](javaEE/Spring/assets/Spring-day04-00.png)
...
![1611544737521](javaEE/Spring/assets/Spring-day04-01.png)
...
![1611546544813](javaEE/Spring/assets/Spring-day04-02.png)
...
![1611547993596](javaEE/Spring/assets/Spring-day04-03.png)
...
![1611548415857](javaEE/Spring/assets/Spring-day04-04.png)
...
![1611553533337](javaEE/Spring/assets/Spring-day05-01.png)
...
![1611557721168](javaEE/Spring/assets/Spring-day05-02.png)
...
![1611559845552](javaEE/Spring/assets/Spring-day05-04.png)

> AOP：纵向开发，横向开发。

![1611559708139](javaEE/Spring/assets/Spring-day05-03.png)
...
![1611560619393](javaEE/Spring/assets/Spring-day05-05.png)

![1611560741954](javaEE/Spring/assets/Spring-day05-06.png)
...
![1611562845493](javaEE/Spring/assets/Spring-day05-07.png)
...
![842724-20200218180120444-1922347182](javaEE/Spring/assets/Spring-day05-08.png)
...
![1611564170576](javaEE/Spring/assets/Spring-day05-09.png)

- SpringAOP中，通过Advice定义横切逻辑，Spring中支持5种类型的Advice: 

![1611564170576](javaEE/Spring/assets/Spring-day05-10.png)
...
![1611627572288](javaEE/Spring/assets/Spring-day05-11.png)
...
![1611628845456](javaEE/Spring/assets/Spring-day05-12.png)
...
![1611629770304](javaEE/Spring/assets/Spring-day05-13.png)
...
![1611659113769](javaEE/Spring/assets/Spring-day05-14.png)

- aop:aspectj-autoproxy——说明 

> 通过aop命名空间的`<aop:aspectj-autoproxy />`声明自动为`spring`容器中那些配置`@aspectJ`切面的`bean`创建代理，织入切面。当然，`spring` 在内部依旧采用`AnnotationAwareAspectJAutoProxyCreator`进行自动代理的创建工作，但具体实现的细节已经被`<aop:aspectj-autoproxy />`隐藏起来了
...
![1612082780813](javaEE/Spring/assets/Spring-day06-01.png)
...
![1612082890158](javaEE/Spring/assets/Spring-day06-02.png)
...
![1612083116957](javaEE/Spring/assets/Spring-day06-03.png)
...
- `SqlSessionFactory` 有一个唯一的必要属性：用于 [[17-JDBC]] 的 `DataSource`。这可以是任意的 `DataSource` 对象，它的配置方法和其它 Spring 数据库连接是一样的。
...
![1612098486767](javaEE/Spring/assets/Spring-day06-04.png)
...
![1612098795729](javaEE/Spring/assets/Spring-day06-05.png)
...
![1612099199499](javaEE/Spring/assets/Spring-day06-06.png)

- dao继承Support类，直接利用 getSqlSession() 获得，然后直接注入SqlSessionFactory。比起方式1，不需要管理SqlSessionTemplate , 而且对事务的支持更加友好。可跟踪源码查看！！！

> 测试：

![1612099841356](javaEE/Spring/assets/Spring-day06-07.png)
...
![1612099869160](javaEE/Spring/assets/Spring-day06-08.png)
...
![1612101872045](javaEE/Spring/assets/Spring-day06-09.png)
...
![1612102651396](javaEE/Spring/assets/Spring-day06-10.png)

- 报错：sql[[12-异常]]，delete写错了。结果 ：插入成功！
...
![1612103530808](javaEE/Spring/assets/10-2.png)
...
![1612104048394](javaEE/Spring/assets/Spring-day06-11.png)

![1612104109948](javaEE/Spring/assets/Spring-day06-12.png)
...
> 如果不使用注解，你的`Spring.xml`配置肯定是多的爆炸，比如这样：
>
> ```javascript
...
> ```
>
> 如果使用了`@Service`，`@Component`，`@Repository`，`@Controller`，`@Resource`，`@Autowired` 这些注解，这些配置统统可以不要。首先要在`SpringMVC.xml`配置自动扫描注解的`tag`。
>
> ```javascript
...
> ```
>
> -  `@Service`用于标注业务`Service`层的类上，有`value`这个属性。
>
> ```javascript
...
> ```
>
> -  `@Controller`用于标注控制`Controller`层的类上。
>
> ```javascript
> @Controller
...
> ```
>
> -  `@Repository`用于标注在`Dao`层的类上，有`value`这个属性。
>
> ```javascript
...
> ```
>
> -  `@Component`就是把类注册到`Spring.xml`文件中。
>
> ```javascript
> @Component
...
> ```
>
> `Dao`层的类继承它就行了，就可以调用`getSqlSession()`进行想要的操作了。
>
> -  `@Resource`默认按名称进行装配字段或者`setter`方法。名称可以通过`name`属性进行指定，如果没有指定`name`属性。当注解写在字段上，默认按字段名进行安装名称查找，如果注解写在`setter`方法上，默认按属性名进行装配，当找不到与名称相匹配的`bean`时候，才会按照类型进行装配。如果`name`属性指定了，那么就只能按名称进行装配了。
>
> ```javascript
> @Service(value = "adminUserService")
> public class AdminUserService implements IAdminUserService {
...
> ```
>
> -  `@Autowired`:默认按类型装配，默认情况下必须要求依赖对象必须存在，如果要运行`null`值，可以设置它的`required`属性为`false`。如果我们想要使用名称进行装配，可以结合`@Qualifier`注解使用。
>
> ```javascript
>     @Autowired
