...
![1729663754225](测试笔记/JMeter/assets/image1.png)
...
8. 上游接口提取数据，供下游参数使用：
   ...
   ![1729671663357](测试笔记/JMeter/assets/image2.png)
...
9. 需要检查响应结果时添加断言；响应为 JSON 用 JSON 断言。
   ...
   ![1729765180001](测试笔记/JMeter/assets/image3.png)
...
11. 线程组 → 右键 → 添加 → 配置元件 → CSV Data Set Config，实现参数化。CSV 有几行数据，线程组就能配几个线程，每线程独享一组数据。
    ...
    ![1731659619952](测试笔记/JMeter/assets/image6.png)
...
2. 添加 JDBC 连接配置：
   ...
   ![1729935970877](测试笔记/JMeter/assets/image7.png)
...
4. 简单控制器下添加取样器 → JDBC 请求：
   ...
   ![1729936245783](测试笔记/JMeter/assets/image8.png)
...
12. 函数助手：
    ...
    ![1731688423867](测试笔记/JMeter/assets/image9.png)
...
13. 正则表达式提取器：从 HTML 源码按特定文字提取值时多用它。
    ...
    ![1729763064979](测试笔记/JMeter/assets/image10.png)
...
14. CSS / jQuery 提取器：从 HTML 按标签和属性提取值或文字时多用它。
    ...
    ![1731686392239](测试笔记/JMeter/assets/image11.png)
...
15. 响应断言：可对状态码、头部值、body 文字断言，是 JMeter 最重要的断言工具。
    ...
    ![1731915752418](测试笔记/JMeter/assets/image12.png)

    上图对响应状态码断言等于 200。

16. JSR223 预处理程序：

    ![1731687262406](测试笔记/JMeter/assets/image13.png)
...
![1729910368396](测试笔记/JMeter/assets/image14.png)
