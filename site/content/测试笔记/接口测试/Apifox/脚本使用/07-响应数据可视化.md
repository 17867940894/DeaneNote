...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490203471-91.png)

## 添加自定义脚本

你可以在前置或后置操作中添加自定义脚本，以增强数据处理能力。

![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490203471-92.png)

## 调用方式

在自定义脚本中使用 `pm.visualizer.set()` 函数，以便将可视化结果显示在响应 body 的 `Visualize` 标签页中。

![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490203471-93.png)
