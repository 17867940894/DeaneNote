...
![CleanShot 2024-11-29 at 11.59.39@2x.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244300-100.png)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244301-101.png)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244301-102.png)
...
`method` *string* 指定 jar 包中调用的方法名，例如 `"add"`。非必填（`className`有值时为必填）。
...
1.将 `execute` 改为 `executeAsync`

2.在方法调用前添加 await 关键字
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244301-103.png)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244301-104.png)
...
3.Java 环境配置参考[安装文档](https://docs.apifox.com/install-java)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785490244301-105.png)
