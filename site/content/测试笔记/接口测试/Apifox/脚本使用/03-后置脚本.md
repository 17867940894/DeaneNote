...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785489993345-25.png)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785489993345-26.png)
...
![image.png](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785489993345-27.png)

例如，可以在目录层级或接口层级中引用：`Bearer {{token}}`。

![img](测试笔记/接口测试/Apifox/脚本使用/assets/image-preview-1785489993345-28.png)
...
1.[断言示例](https://docs.apifox.com/assertion-examples)

2.[环境变量、全局变量、临时变量使用示例](https://docs.apifox.com/use-variables-in-scripts)

3.[脚本读取/修改接口请求信息](https://docs.apifox.com/access-modify-request-data)

4.[参数加密/解密](https://docs.apifox.com/js-libraries)
