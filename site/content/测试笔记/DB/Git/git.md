...
![1616032657017](测试笔记/DB/Git/assets/1616032657017.png)
...
![1616034871080](测试笔记/DB/Git/assets/1616034871080.png)
...
- 在Git终端中输入`git init`指令，创建版本库（就是一个.git目录）
  ...
  ![1616036472274](测试笔记/DB/Git/assets/1616036472274.png)
...
- 注册账号
  ...
  ![1616039783023](测试笔记/DB/Git/assets/1616039783023.png)

- 创建远程仓库：https://gitee.com/qfytao/j2010.git

- 远程仓库管理（添加开发人员）

  ![1616040201202](测试笔记/DB/Git/assets/1616040201202.png)
...
# 我的博客项目
git remote add origin https://gitee.com/dingwenwang/MyBlog.git
# 我的学习仓库
git remote add origin https://gitee.com/dingwenwang/StudyBase.git
# 2024 project 
https://github.com/17867940894/study_trace/tree/e542873066c8837357c804dcb34fa848f38aa295/My_project/2024-project
```
...
![image-20240910221607202](测试笔记/DB/Git/assets/image-20240910221607202.png)

> 问题原因：
> 出现这种问题的原因是因为本地仓库刚建立，没有远程仓库的[[README]].md文件，所以导致的上传失败.
> 解决方法：
> 使用下面的命令将文件从远程仓库下载下来
>
> ```shell
...
![1616049675765](测试笔记/DB/Git/assets/1616049675765.png)
...
- 拉取远程仓库
  ...
  git pull https://gitee.com/dingwenwang/js-group-repository.git
  ```
...
![1616118889055](测试笔记/DB/Git/assets/1616118889055.png)
...
- 添加到暂存区的操作可以设置默认添加
  ...
  ![1616120607480](测试笔记/DB/Git/assets/1616120607480.png)
...
7. 将本地dev分支push到远程仓库，新建远程仓库的dev分支
   ...
   ![1616125529083](测试笔记/DB/Git/assets/1616125529083.png)

8. 设置远程仓库中master分支为保护分支

   ![1616125664648](测试笔记/DB/Git/assets/1616125664648.png)
