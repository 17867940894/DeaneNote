...
> 安装mysql：
>
> ![image-20220207143856470](测试笔记/DB/SQL/assets/image-20220207143856470.png)
>
> ![image-20220207143918647](测试笔记/DB/SQL/assets/image-20220207143918647.png)
>
> ![image-20220207144019146](测试笔记/DB/SQL/assets/image-20220207144019146.png)
>
> ![image-20220207144107036](测试笔记/DB/SQL/assets/image-20220207144107036.png)
>
> ![image-20220207144124042](测试笔记/DB/SQL/assets/image-20220207144124042.png)
>
> ![image-20220207144254844](测试笔记/DB/SQL/assets/image-20220207144254844.png)
>
> ![image-20220207144311999](测试笔记/DB/SQL/assets/image-20220207144311999.png)
>
> ![image-20220207144344016](测试笔记/DB/SQL/assets/image-20220207144344016.png)
>
> ![image-20220207144653859](测试笔记/DB/SQL/assets/image-20220207144653859.png)
>
> ![image-20220207144816732](测试笔记/DB/SQL/assets/image-20220207144816732.png)
>
> ![image-20220207144854115](测试笔记/DB/SQL/assets/image-20220207144854115.png);
>
> ![image-20220207145026026](测试笔记/DB/SQL/assets/image-20220207145026026.png)
>
> ![image-20220207145128505](测试笔记/DB/SQL/assets/image-20220207145128505.png)
>
> ![image-20220207145441067](测试笔记/DB/SQL/assets/image-20220207145441067.png)
>
> ![image-20220207145846536](测试笔记/DB/SQL/assets/image-20220207145846536.png)
>
> ![image-20220207150104078](测试笔记/DB/SQL/assets/image-20220207150104078.png)
>
> ![image-20220207150125274](测试笔记/DB/SQL/assets/image-20220207150125274.png)
>
> ![image-20220207150323227](测试笔记/DB/SQL/assets/image-20220207150323227.png)
>
...
>    ```
>
>    ![image-20240410104914510](测试笔记/DB/SQL/assets/image-20240410104914510.png)
>
> 7. 根据旧表的结构创建出结构相同的新表
>
>    ```sql
...
>     ```
>
>     ![image-20240415113608534](测试笔记/DB/SQL/assets/image-20240415113608534.png)
...
> ```
>
> ![image-20240415102943799](测试笔记/DB/SQL/assets/image-20240415102943799.png)
...
>    ```
>
>    ![image-20240325151455925](测试笔记/DB/SQL/assets/image-20240325151455925.png)
>
> 5. 模糊查询
>
>    关键字：`like`
...
>
> 例如：![image-20240325222513413](测试笔记/DB/SQL/assets/image-20240325222513413.png)
...
> 6. group_concat()
>
>    - 在 MySQL 中可 以在 GROUP BY 子句中使用 GROUP _CONCAT( ) 函数, 将每个分组中各个字段的值显示 出来。
>    - ![image-20240520104322618](测试笔记/DB/SQL/assets/image-20240520104322618.png)
>
> 7. concat()
>
>    ```sql
...
>    ```
>
>    ![image-20240617111605008](测试笔记/DB/SQL/assets/image-20240617111605008.png)
>
> 8. trim()
>
>     去除参数字符串的==空格==，去除首位空格，保留中间的
>
>    ![image-20240617112726940](测试笔记/DB/SQL/assets/image-20240617112726940.png)
>
> ![image-20240325223036497](测试笔记/DB/SQL/assets/image-20240325223036497.png)
>
> 注：
>
> 1. 聚合函数不计算`null`值
...
>
> ==说明：==
> 1.自动去重：union 默认会自动去重，如果不想去重，可以加上 all
> 2.排序：先合并再排序，不能先排序再合并
> 3.列数：union 合并的两个 select查询(结果是表格) 的列数必须一致
> 4.列名：两个表格列名不需要一致，以第一个表格的列名为准
>
> ![image-20240617105526819](测试笔记/DB/SQL/assets/image-20240617105526819.png)
...
> ```
>
> ![image-20240330102401437](测试笔记/DB/SQL/assets/image-20240330102401437.png)
>
> 注：`outer`可以省略
